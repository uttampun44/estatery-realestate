                    ...
                    <div className="ml-48 mx-auto sm:px-6 lg:px-8">
                        <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div className="create_properties_agent form p-4">
                                <form onSubmit={addProperties} method="POST" action={route('add-properites.store')} encType="multipart/form-data">
                                    <div className="grid grid-cols-3 gap-x-8">
                                        <div className="agent_name">
                                            ...
                                            >
                                                {users.map((user) => (
                                                    <option key={user.id} onChange={PropertiesVal}>
                                                        {user.name}
                                                    </option>
                                                ))}
                                            </select>
                                        ...
                                        <div className="buy_rent">
                                            ...
                                            >
                                                {options.map((option) => (
                                                    <option key={option.id} onChange={PropertiesVal}>
                                                        {option.sale_rent}
                                                    </option>
                                                ))}
                                            </select>
                                        ...
                                        <div className="cooling">
                                            ...
                                            <select
                                                ...
                                                className="my-4 rounded-md w-full  bg-blue-50 outline-none"
                                            >
                                                <option value="1" onChange={PropertiesVal}>Yes</option>
                                                <option value="0" onChange={PropertiesVal}>No</option>
                                            </select>
                                        </div>
                                        ...
                                        <div className="active">
                                            ...
                                            <select
                                                ...
                                                className="my-4 rounded-md w-full bg-blue-50 outline-none"
                                            >
                                                <option value="1" onChange={PropertiesVal}>
                                                    Active
                                                </option>
                                                <option value="2" onChange={PropertiesVal}>
                                                    Inactive
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div className="add_description mb-4">
                                        ...
                                        <textarea
                                            ...
                                            id="editor"
                                            onChange={PropertiesVal} ></textarea>
                                    </div>
